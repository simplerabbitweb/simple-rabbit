...
<section style="background:var(--bg); padding:0; border-bottom:1px solid var(--rule-vt); overflow:hidden;">
  <div class="acrr-grid" style="display:grid; grid-template-columns:1fr 1fr; min-height:500px;">
    <div class="acrr-img" style="overflow:hidden; display:flex;">
      <img src="/acrr-checklist.png" alt="ACRR Patient Acquisition Checklist" style="width:100%; min-height:360px; object-fit:cover; display:block; flex:1;">
    </div>
